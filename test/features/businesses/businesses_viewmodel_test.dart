...
import 'package:ibivibe/features/businesses/viewmodels/businesses_viewmodel.dart';
...
void main() {
  ...
  group('businesses controller', () {
    test('build returns empty list when no active account', () async {
      ...
      final state = await container.read(businessesViewModelProvider.future);
    ...
    test('getAllBusinesses updates state with businesses', () async {
      ...
      final container = createContainer();
      await container.read(businessesViewModelProvider.future);

      final notifier = container.read(businessesViewModelProvider.notifier);
      await notifier.getAllBusinesses();

      final state = container.read(businessesViewModelProvider);
