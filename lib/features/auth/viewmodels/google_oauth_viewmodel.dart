...
import 'package:ibivibe/features/auth/google_oauth_data_state.dart';
...
part 'google_oauth_viewmodel.g.dart';

@Riverpod(keepAlive: true)
class GoogleOAuthViewModel extends _$GoogleOAuthViewModel
  ...
  Future<bool> signInWithGoogle() async {
    ...
    try {
      ...
      if (googleAuthResult.isNewUser) {
        ...
        ref.read(authViewModelProvider.notifier).initSession(authResult);
        state = state.copyWith(
          isLoading: false,
          googleAuthResult: googleAuthResult,
        );
