...
part 'google_onboarding_viewmodel.g.dart';

@Riverpod(keepAlive: true)
class GoogleOnboardingViewModel extends _$GoogleOnboardingViewModel
  ...
  Future<void> submit() async {
    ...
    final failure = ref.read(googleOAuthViewModelProvider).failure;
    if (failure != null) {
      logControllerError(
        action: AuthAction.completeGoogleRegistration,
        failure: failure,
