...
class UserCompaniesInterestsScreen extends ConsumerStatefulWidget {
  const UserCompaniesInterestsScreen({super.key});

  @override
  ConsumerState<UserCompaniesInterestsScreen> createState() =>
      _UserCompaniesInterestsScreenState();
}

class _UserCompaniesInterestsScreenState
    extends ConsumerState<UserCompaniesInterestsScreen> {
  ...
  void _handleSkip() async {
    ...
    try {
      await ref
          .read(profileInterestsControllerProvider.notifier)
